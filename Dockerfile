...
RUN curl --silent --output fabric8.zip http://central.maven.org/maven2/io/fabric8/fabric8-karaf/1.1.0.Beta3/fabric8-karaf-1.1.0.Beta3.zip
RUN unzip -q fabric8.zip 
RUN ls -al
#RUN mv fabric8-karaf-1.1.0-SNAPSHOT fabric8-karaf
RUN mv fabric8-karaf-1.1.0.Beta3 fabric8-karaf
RUN rm fabric8.zip
